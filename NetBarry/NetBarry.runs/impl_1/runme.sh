...
HD_PWD='/home/guy/Documents/NetBarry/NetBarry/NetBarry/NetBarry.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log netbarry_fpga_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source netbarry_fpga_wrapper.tcl -notrace
